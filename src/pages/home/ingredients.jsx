...
const Ingredients = (props) => {
  //svg wavy line path
  const lineShape = `M170.650-0.303637L170.568 48.7971C170.568 48.7971 170.563 54.7441 179.203
  ...
  return (
    <Fragment>
      <section
        className={`${classes.fitScreen} ${classes["ingredients-section"]}`}
      >
        ...
        <ContentWrapper>
          <div ref={ingredientsRef} className={classes.text}>
