  ...
  return (
    <Modal onClose={props.hideFoodInfoHandler}>
      ...
      {props.foodInfo !== undefined ? (
        <div>
          ...
          <div className={classes["nutrition-section"]}>
            ...
            <span
              className={`${classes["category-text"]} ${classes["nutrition-value"]}`}
            >
              {props.foodInfo[0].nutrition[0].carbs}kcal
            </span>
          </div>
          <div className={classes["nutrition-section"]}>
            ...
            <span
              className={`${classes["category-text"]} ${classes["nutrition-value"]}`}
            >
              {props.foodInfo[0].nutrition[0].protein}g
            </span>
          </div>
          <div className={classes["nutrition-section"]}>
            ...
            <span
              className={`${classes["category-text"]} ${classes["nutrition-value"]}`}
            >
              {props.foodInfo[0].nutrition[0].fat}g
            </span>
          </div>
          <h2 className={classes["category-title"]}>Allergens</h2>
          <p className={classes["category-text"]}>
            {props.foodInfo[0].allergens}
          </p>
        </div>
      ) : (
        <p className={classes["category-text"]}>
      ...
      <div className={classes.actions}>
        <button className={classes.button} onClick={props.hideFoodInfoHandler}>
          Close
        </button>
      </div>
    </Modal>
